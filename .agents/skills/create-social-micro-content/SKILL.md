...
- The central observation or tension.
- The concrete problem the author noticed.
- Why the problem matters in practice.
- What changed in the author's thinking.
- The most interesting trade-off, constraint, or surprising detail.
...
Use the same voice as the author's personal engineering writing:
...
Create posts for X that are concise but not empty.

Prefer:

- 1 to 2 variants unless the user asks for more.
- Roughly 500 to 1,200 characters when the idea needs space.
- Short paragraphs with a strong opening observation.
...
1. A sharp opening observation.
2. A few lines of context from the article's real substance.
3. The author's reflection, trade-off, or changed thinking.
4. A clean ending that leaves the idea open without baiting engagement.

## LinkedIn Output

Create LinkedIn content that is medium-sized and self-contained.

Prefer:

- 1 polished LinkedIn post unless the user asks for more.
- Roughly 1,200 to 2,500 characters, adjusted to the depth of the article.
- Paragraphs that are easy to scan without becoming a listicle.
...
1. A grounded opening that names the tension.
2. A short explanation of the situation or pattern.
3. The insight from the article, including nuance or constraints.
4. A practical implication for engineering, product, or leadership.
5. A calm ending that keeps the discussion open.
...
- "I unpacked this in detail here:"

Prefer either a plain URL on its own line or a restrained line such as:
...
- Extract the core hook rather than summarizing the article mechanically.
- Preserve the author's uncertainty and context.
- Keep technical terms precise.
- Use concrete language from the source when it carries the insight.
- Make each post useful on its own.
- Let the article's best idea lead.

Do not:

- Add claims the article does not support.
- Turn the piece into generic advice.
- Overfit to platform tropes.
- Add artificial drama.
- Make the author sound more certain, polished, or promotional than the source.
