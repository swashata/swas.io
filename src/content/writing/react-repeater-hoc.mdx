...
image: ../../assets/images/react-repeater.png
...
The issue at hand was to functionally repeat a react component N times. So I came up with
this quick HOC.
 ...
 */
const Repeater =
  (Component, times = 1, keyPrefix = 'rp') =>
  (props) => {
    const Repeated = [];
...
dynamically create a Key (_Maybe this is a bad idea, but if you have something better let
me know_).
