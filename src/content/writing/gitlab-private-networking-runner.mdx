---
image: '../../assets/images/gitlab-ci-cd.png'
...
![GitLab CI/CD](../../assets/images/gitlab-ci-cd.png)

So I have this 3 servers running for my complete GitLab setup with automated CI/CD
and code analysis with SonarQube. (_About which I will surely write_).

![GitLab CI/CD](../../assets/images/linode-instances.png)
...
![GitLab CI/CD](../../assets/images/gitlab-runner.png)
